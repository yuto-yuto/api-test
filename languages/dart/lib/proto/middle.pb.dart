...
class DownloadResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DownloadResponse', createEmptyInstance: create)
...
class UploadRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UploadRequest', createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'filename')
...
class UploadResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UploadResponse', createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'result')
    ..aInt64(2, _omitFieldNames ? '' : 'writtenSize', protoName: 'writtenSize')
  ...
  @$pb.TagNumber(2)
  $fixnum.Int64 get writtenSize => $_getI64(1);
  @$pb.TagNumber(2)
  set writtenSize($fixnum.Int64 v) { $_setInt64(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasWrittenSize() => $_has(1);
  @$pb.TagNumber(2)
  void clearWrittenSize() => clearField(2);
...
class CommunicateRequest extends $pb.GeneratedMessage {
  ...
  CommunicateRequest._() : super();
  factory CommunicateRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CommunicateRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CommunicateRequest', createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  CommunicateRequest clone() => CommunicateRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CommunicateRequest copyWith(void Function(CommunicateRequest) updates) => super.copyWith((message) => updates(message as CommunicateRequest)) as CommunicateRequest;
  ...
  static $pb.PbList<CommunicateRequest> createRepeated() => $pb.PbList<CommunicateRequest>();
  @$core.pragma('dart2js:noInline')
  static CommunicateRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CommunicateRequest>(create);
...
class CommunicateResponse extends $pb.GeneratedMessage {
  factory CommunicateResponse() => create();
  CommunicateResponse._() : super();
  factory CommunicateResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CommunicateResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CommunicateResponse', createEmptyInstance: create)
    ..aInt64(1, _omitFieldNames ? '' : 'currentCount', protoName: 'currentCount')
    ..aInt64(2, _omitFieldNames ? '' : 'value')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  CommunicateResponse clone() => CommunicateResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CommunicateResponse copyWith(void Function(CommunicateResponse) updates) => super.copyWith((message) => updates(message as CommunicateResponse)) as CommunicateResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static CommunicateResponse create() => CommunicateResponse._();
  CommunicateResponse createEmptyInstance() => create();
  static $pb.PbList<CommunicateResponse> createRepeated() => $pb.PbList<CommunicateResponse>();
  @$core.pragma('dart2js:noInline')
  static CommunicateResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CommunicateResponse>(create);
  static CommunicateResponse? _defaultInstance;

  @$pb.TagNumber(1)
  $fixnum.Int64 get currentCount => $_getI64(0);
  @$pb.TagNumber(1)
  set currentCount($fixnum.Int64 v) { $_setInt64(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasCurrentCount() => $_has(0);
  @$pb.TagNumber(1)
  void clearCurrentCount() => clearField(1);
